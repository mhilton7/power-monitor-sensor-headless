...
| 13 commands | A/B CRC ledger/all required types/states/idempotency/expiry/progress; token-zeroized destructive intent; restartable phase journal; authenticated-result-ack cleanup | exhaustive crash-at-every-phase host model plus ESP-IDF build; physical power-cut HIL pending |
...
| 27 tests | host C/Python, 36 faults, 120-day simulator, physical HIL runner/verifier/schema | automated pass; HIL pending |
