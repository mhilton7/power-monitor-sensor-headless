...
typedef enum {
    PM_COMMAND_REBOOT = 0,
    PM_COMMAND_RESERVED_1 = 1,
    PM_COMMAND_RESERVED_2 = 2,
    PM_COMMAND_DIAGNOSTICS_SNAPSHOT = 3,
    PM_COMMAND_NETWORK_SELF_TEST = 4,
    PM_COMMAND_METER_SELF_TEST = 5,
    PM_COMMAND_RESERVED_6 = 6,
    PM_COMMAND_RESERVED_7 = 7,
    PM_COMMAND_RESERVED_8 = 8,
    PM_COMMAND_RESERVED_9 = 9,
    PM_COMMAND_RESERVED_10 = 10,
    PM_COMMAND_OTA_INSTALL = 11,
    PM_COMMAND_RESERVED_12 = 12,
    PM_COMMAND_RESERVED_13 = 13,
    PM_COMMAND_RESERVED_14 = 14,
    PM_COMMAND_TYPE_COUNT = 15,
} pm_command_type_t;
