...
#define PM_TELEMETRY_ENDPOINT "/api/v1/device/telemetry/v2"
...
typedef struct {
    int64_t next_telemetry_us;
    int64_t telemetry_period_us;
    pm_telemetry_backoff_t server_backoff;
...
typedef enum {
    ...
    PM_HEALTH_SERVER_UNAVAILABLE = 1U << 2,
    PM_HEALTH_OTA_FAILED = 1U << 3,
    PM_HEALTH_OTA_ROLLED_BACK = 1U << 4,
...
esp_err_t pm_network_apply_runtime_config(pm_network_context_t *context,
